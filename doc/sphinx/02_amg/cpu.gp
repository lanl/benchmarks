...
set style line 3 linetype 1 dashtype 1 linecolor rgb "#0000FF" linewidth 2 pointtype 6 pointsize 3
...
set title "AMG2023 Strong Scaling for Problem 1, 160 x 160 x 160, Roci" font "serif,22"
...
set title "AMG2023 Strong Scaling for Problem 1, 200 x 200 x 200, Roci" font "serif,22"
plot "roci_1_200.csv" using 1:2 with linespoints linestyle 1, "" using 1:3 with line linestyle 2

set output "roci_2_200.png"
set title "AMG2023 Strong Scaling for Problem 2, 200 x 200 x 200, Roci" font "serif,22"
plot "roci_2_200.csv" using 1:2 with linespoints linestyle 1, "" using 1:3 with line linestyle 2

set output "roci_2_256.png"
set title "AMG2023 Strong Scaling for Problem 2, 256 x 256 x 256, Roci" font "serif,22"
plot "roci_2_256.csv" using 1:2 with linespoints linestyle 1, "" using 1:3 with line linestyle 2

set output "roci_2_320.png"
set title "AMG2023 Strong Scaling for Problem 2, 320 x 320 x 320, Roci" font "serif,22"
plot "roci_2_320.csv" using 1:2 with linespoints linestyle 1, "" using 1:3 with line linestyle 2

set output "roci_mem.png"
set title "AMG2023 FOM at varying memory usage, Problem 1 and 2, Roci" font "serif,22"
plot "roci_mem.csv" using 1:2 with linespoints linestyle 1, "" using 1:3 with line linestyle 3
