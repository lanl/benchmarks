...
set title "Parthenon-VIBE Strong Scaling Performance on CTS-1, 40% Memory Footprint" font "serif,22"
plot "cpu_40.csv" using 1:2 with linespoints linestyle 1, "" using 1:3 with line linestyle 2


set output "cpu_60.png"
set title "Parthenon-VIBE Strong Scaling Performance on CTS-1, 60% Memory Footprint" font "serif,22"
