...
public class OSUBandwidthOMPI extends BenchmarkUtils {
  ...
  public OSUBandwidthOMPI() {

  }

  public OSUBandwidthOMPI(String[] args) {
    super(args, BenchmarkUtils.OSU_OMPI_BW_TEST);
    this.args = args;
  }
  ...
  protected void printHeader() {
    System.out.println(OSU_OMPI_BW_TEST);
    System.out.println("# Size [B]" + "\t\t" + "Bandwidth [MB/s]" + "\t" +
        "Bandwidth [Gb/s]");
  }
  
  public static void main(String[] args) throws Exception {
    OSUBandwidthOMPI bwTest = new OSUBandwidthOMPI(args);
