...
class CceWrapper(module_wrapper.ModuleWrapper):
    def __init__(self):
        # This is a wrapper for cray compiler, for any version.
        super().__init__('cce',
                         "Wrapper for the CCE module",
                         None,
                         self.PRIO_COMMON)
    ...
    def load(self, var_man, requested_version=None):
        ...
        if var_man['sys_arch'] == 'x86_64':
            actions.append(ModuleSwap('PrgEnv-cray', '', 'PrgEnv-intel', ''))
    ...
    def remove(self, var_man, requested_version=None):
        ...
        actions.append(ModuleUnload('PrgEnv-cray', ''))
